...
class TestAPIEndpoints:
    ...
    def test_dem_compute_slope(self, mock_processor, api_client, temp_dir):
        ...
        response = api_client.post("/dem/compute_slope", json={
    ...
    @pytest.mark.asyncio
    async def test_traverse_endpoint_mocked(self, mock_get, api_client, mock_nasa_traverse_response):
...
class TestMissionPlanning:
    ...
    def test_plan_scenario_dust_storm(self, api_client):
        ...
        response = api_client.post("/plan_scenario", json={
            "scenario": "Dust storm incoming"
        })
    ...
    def test_plan_endpoint_with_constraints(self, api_client, 
                                           mock_mission_goals, mock_activities):
        ...
        response = api_client.post("/plan", json={
    ...
    def test_export_sequence(self, api_client, mock_activities):
        ...
        response = api_client.post("/export_sequence", json={
...
class TestErrorHandling:
    ...
    def test_route_nonexistent_dem(self, api_client):
        ...
        response = api_client.post("/route_from_dem", json={
...
class TestEndToEnd:
    ...
    def test_full_mission_planning_flow(self, mock_solver, mock_optimizer, 
                                       api_client,
                                       mock_mission_goals, mock_activities):
        ...
        mock_solver.evaluate.return_value = {
            'ok': True,
            'violations': []
        }
