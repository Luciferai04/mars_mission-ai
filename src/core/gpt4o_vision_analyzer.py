...
class GPT4oVisionAnalyzer:
    ...
    def analyze_terrain_image(self, 
                              image_path: str,
                              camera_type: str,
                              sol: int,
                              coordinates: tuple,
    ...
    def _generate_vision_prompt(self,
                                camera_type: str,
                                sol: int,
                                coordinates: tuple,
...
Analyze the image with mission-critical precision."""
    ...
    def _generate_mission_recommendation(self, 
                                        analyses: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        if summary['overall_safety_rating'] == 'HAZARD':
            ...
            return {
                'proceed': True,
                'conditions': ['Reduce speed', 'Monitor wheel currents', 'Ready abort sequence'],
