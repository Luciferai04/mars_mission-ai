...
class MultiSolPlanner:
    ...
    def plan_multi_sol_mission(self,
                               ...
                               constraints: Optional[Dict[str, Any]] = None) -> MultiSolMissionPlan:
    ...
    def _optimize_multi_sol_route(self,
    ...
    def _prioritize_and_cluster_targets(self,
                                       start: Tuple[float, float],
    ...
    def _find_next_optimal_target(self,
                                 current: Tuple[float, float],
                                 candidates: List[Dict[str, Any]],
                                 distance_budget: float) -> Optional[Dict[str, Any]]:
    ...
    def _plan_single_sol(self,
                        ...
                        cumulative_state: Dict[str, Any]) -> SolPlan:
    ...
    def _plan_target_activities(self,
                               target: Dict[str, Any],
                               objectives: Dict[str, Any],
                               power_budget: float) -> List[Dict[str, Any]]:
        ...
        if priority == 'HIGH' and target_type in ['rock', 'sample_site', 'geological']:
            sample_power = (self.power_costs_wh['arm_deployment'] + 
                          self.power_costs_wh['sample'])
            ...
            if power_budget >= sample_power:
                activities.append({
                    ...
                    'duration_hours': (self.time_costs_hours['arm_deployment'] +
    ...
    def _build_mission_plan(self,
                           sol_plans: List[SolPlan],
                           objectives: Dict[str, Any],
                           constraints: Dict[str, Any]) -> MultiSolMissionPlan:
        ...
        continuity_score = 1.0 - (backtracking / max(cumulative['total_distance_m'], 1.0))
        ...
        return MultiSolMissionPlan(
            mission_name=constraints.get('mission_name', f'Mission_{datetime.utcnow().strftime("%Y%m%d")}'),
    ...
    def _calculate_science_value(self,
                                sol_plans: List[SolPlan],
    ...
    def _generate_contingency_plans(self,
                                   ...
                                   env_forecast: Dict[int, Dict[str, Any]]) -> List[Dict[str, Any]]:
